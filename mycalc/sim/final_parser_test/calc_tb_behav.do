...
add wave -group "parser" -radix Decimal uut/parser_sm_inst/*
add wave -group "char_unit" -radix Decimal uut/char_unit_inst/*
add wave -group "b2bcd" -radix Decimal uut/b2bcd_ent_inst/*
